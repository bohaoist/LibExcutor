...
CLStatus CLSharedConditionVariableImpl::InitializeSharedObject(SLSharedObjectHead *pObject)
{
	...
	if(r != 0)
	{
		CLLogger::WriteLogMesg("In CLSharedConditionVariableImpl::InitializeSharedObject(), pthread_condattr_init error", r);
		return CLStatus(-1, r);
	}
	r = pthread_condattr_setpshared(&attr,PTHREAD_PROCESS_SHARED);
	if(r != 0)
	{
		CLLogger::WriteLogMesg("In CLSharedConditionVariableImpl::InitializeSharedObject(), pthread_condattr_setpshared error", r);
	...
	if(r != 0)
	{
		CLLogger::WriteLogMesg("In CLSharedConditionVariableImpl::InitializeSharedObject(), pthread_cond_init error", r);
		pthread_condattr_destroy(&attr);
	...
	if(r != 0)
	{
		CLLogger::WriteLogMesg("In CLSharedConditionVariableImpl::InitializeSharedObject(), pthread_condattr_destroy error", r);
		return CLStatus(-1, r);
	}
	return CLStatus(0, 0);
}
...
CLStatus CLSharedConditionVariableImpl::DestroySharedObject(SLSharedObjectHead *pObject)
{
	...
	if(r != 0)
	{
		CLLogger::WriteLogMesg("In CLSharedConditionVariableImpl::DestroySharedObject(), pthread_cond_destroy error", r);
		return CLStatus(-1, r);
	}
	return CLStatus(0,0);
